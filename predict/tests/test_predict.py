...
class TestPredict(unittest.TestCase):
    ...
    def test_predict(self):
        ...
        with tempfile.TemporaryDirectory() as model_dir:
            ...
            # run a prediction
            predictions_obtained = textpredictmodel.predict("ruby on rails: how to change BG color of options in select list, ruby-on-rails")
            print(predictions_obtained)

            # print predictions_obtained length
            print(len(predictions_obtained))
        ...
        self.assertGreaterEqual(len(predictions_obtained), 2)
