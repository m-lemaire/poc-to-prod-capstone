...
class TestLocalTextCategorizationDataset(unittest.TestCase):
    def test_load_dataset_returns_expected_data(self):
        ...
        dataset = utils.LocalTextCategorizationDataset.load_dataset('path', 1)
    ...
    def test__get_num_samples_is_correct(self):
        ...
        dataset = utils.LocalTextCategorizationDataset("toto", 1, train_ratio=0.5, min_samples_per_label=1)
    ...
    def test_get_train_batch_raises_assertion_error(self):
        ...
        with self.assertRaises(AssertionError):
            dataset = utils.LocalTextCategorizationDataset("path", 1, train_ratio=0.5, min_samples_per_label=1)
